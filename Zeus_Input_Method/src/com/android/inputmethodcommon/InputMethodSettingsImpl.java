...
/* package private */class InputMethodSettingsImpl implements
	 ...
	 * @param prefScreen
	 *            a PreferenceScreen of PreferenceActivity or
	 *            PreferenceFragment.
		...
		mSubtypeEnablerPreference
				.setOnPreferenceClickListener(new OnPreferenceClickListener() {
					...
					public boolean onPreferenceClick(Preference preference) {
						...
						intent.putExtra(Settings.EXTRA_INPUT_METHOD_ID,
								mImi.getId());
	...
	private static InputMethodInfo getMyImi(Context context,
	...
	private static String getEnabledSubtypesLabel(Context context,
